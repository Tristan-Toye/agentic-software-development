...
# Source: sub-agents/implementer.md
# Narrowing lost — Claude Code cannot scope Bash: `permission.bash` denies git push, git push *, git push --*
name: implementer
description: >-
...
exactly: `Read`, `Grep`, `Glob`, `Bash`, `Edit`, `Write`. Nothing else is
available to you, whatever the text above implies.
