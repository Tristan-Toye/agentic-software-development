...
# Source: sub-agents/stub-materialiser.md
# Narrowing lost — Claude Code cannot scope Bash: `permission.bash` denies git *
...
exactly: `Read`, `Grep`, `Glob`, `Bash`, `Write`. Nothing else is available
to you, whatever the text above implies.
